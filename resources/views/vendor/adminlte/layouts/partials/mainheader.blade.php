...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-mini">@lang('aisya/header.app_title_mini')</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg">@lang('aisya/header.app_title') </span>
    </a>
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <!-- User Image -->
                                            <img src="{{ Gravatar::get($user->email ? $user->email : 'null@null.xyz') }}" class="img-circle" alt="User Image"/>
                                        </div>
                    ...
                    <li class="dropdown user user-menu" id="user_menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    {{ Auth::user()->name }}
                                    <small>@lang('aisya/body.login_version')</small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            <li class="user-body">
