...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function initApp() {
            ...
            if (localStorage.getItem('avi_casting_kanban_int') !== null && localStorage.getItem('avi_casting_code1') !==
                null && localStorage.getItem('avi_casting_code2') !== null && localStorage.getItem('avi_casting_code3') !==
                null) {
                sendDataAjax();
            }
        }
        ...
        $(document).ready(function() {
            ...
            if (localStorage.getItem('avi_casting_kanban_int') != null) {
                $('#part-internal').text(localStorage.getItem('avi_casting_kanban_int').substring(41, 53).concat(
                    ' (', localStorage.getItem('avi_casting_kanban_int').substring(100, 104), ')'));
            }
