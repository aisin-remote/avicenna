...
INSERT INTO `ais_apps` (`id`, `apps_tcode`, `apps_level`, `apps_has_child`, `apps_sname`, `apps_tcode_parent`, `apps_tcode_root`, `apps_route`, `apps_fname`, `apps_icon_code`, `apps_icon_path`, `created_at`, `updated_at`) VALUES
	...
	(3, 'PI01', 2, 0, 'pis_scan', 'PI00', 'AV00', 'pis/scan', 'PIS Scanner', 'fa fa-circle-o', '', '2017-08-21 11:54:36', '2017-08-21 11:54:37'),
	...
	(6, 'ST01', 2, 0, 'sto_entry', 'ST00', 'AV00', 'sto/entry', 'STO Data Entry', 'fa fa-circle-o', '', '2017-08-21 11:57:31', '2017-08-21 11:57:32'),
...
-- Dumping data for table avicenna.dev.users: ~1 rows (approximately)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `name`, `email`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Ferry Avianto', 'ferry@aiia.co.id', '$2y$10$1rJ/l5UiRxByX6zXezWTDej9pXkYBvtaKRc39L4uUpGOK/vu91fDG', NULL, '2017-08-21 08:15:12', '2017-08-21 08:15:12');
