...
class CreateAviMutationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('avi_mutations', function (Blueprint $table) {
            ...
            $table->string('part_kind', 10)->nullable();                // dev-1.0, Ferry, 20170926
            $table->string('part_dock', 10)->nullable();                // dev-1.0, Ferry, 20170926
            $table->string('back_number')->nullable();                  // dev-1.0, Ferry, 20170926
